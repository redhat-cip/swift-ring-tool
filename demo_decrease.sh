...
echo -e "Decrease partition power, write new ring - number of partitions increased\n"
python swiftringtool.py -v --decrease-partition-power -r /etc/swift/object.builder
swift-ring-builder /etc/swift/object.builder 
